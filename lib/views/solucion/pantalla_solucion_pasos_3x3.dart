...
class PantallaSolucionPasos3x3 extends StatelessWidget {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            // Liberamos la memoria del reproductor al volver atrás
            Get.delete<GestorReproduccion3x3>();
            Get.back();
          },
        ),
      ),
      ...
      body: FondoDecorativo(
        child: SafeArea(
          child: GetBuilder<GestorReproduccion3x3>(
            init: gestor,
            builder: (controlador) {
                        ...
                        if (controlador.totalPasos > 0)
                          SliderTheme(
                            ...
                            child: Slider(
                              ...
                              onChanged: (val) => controlador.saltarA(val.toInt()),
                            ),
                          ),
                        const SizedBox(height: 8),
                        Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton.large(
                              ...
                              child: Icon(
                                controlador.estaReproduciendo ? Icons.pause_rounded : Icons.play_arrow_rounded,
                                size: 48,
                              ),
                            ),
                            const SizedBox(width: 24),
