...
class _EstadoTarjetaMenuAnimada extends State<TarjetaMenuAnimada> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controladorToque = AnimationController(
      vsync: this,
  ...
  Widget build(BuildContext context) {
    // Lógica dinámica de colores según el tema
      ...
      child: SlideTransition(
        ...
        child: GestureDetector(
          ...
          onTapUp: (_) {
            ...
            // IMPORTANTE: Asegúrate de tener importado el GestorConfiguracion en este archivo
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          ...
                          shadows: [
                            Shadow(
                              color: Theme.of(context).colorScheme.primary.withOpacity(esOscuro ? 1.0 : 0.4),
                              blurRadius: 15,
                            )
                          ],
                        ),
